...
class DesktopController:
    ...
    def move_(self, x, y, duration=0.1, relative=False, from_capture=False):
        ...
        if from_capture:
            ...
            current_x, current_y = interception.get_cursor_position()
    ...
    def click_(self, x, y, button='left', clicks=1, interval=0.1, from_capture=False):
        ...
        """
        target_x, target_y = self.move_(x, y, from_capture=from_capture)
        time.sleep(0.1)
        
        for i in range(clicks):
            interception.click(x=target_x, y=target_y, button=button)
            current_pos = interception.get_cursor_position()
    ...
    def type_(self, text, interval=0.05):
        ...
        for char in text:
            interception.key_down(char)
            time.sleep(0.05)
            interception.key_up(char)
            time.sleep(interval)
    ...
    def click_desktop_template(self, template_path, confidence=0.8, button='left', clicks=1):
        ...
        if result:
            ...
            for i in range(clicks):
                interception.click(x=screen_x, y=screen_y, button=button)
                if clicks > 1:
                    time.sleep(0.1)
    ...
    def check_desktop_applications(self):
        ...
        """
        anaconda_path = r"C:\Users\ferha\Desktop\ko_upgrade/desktop_images/anaconda_prompt.png"
        knight_path = r"C:\Users\ferha\Desktop\ko_upgrade/desktop_images/knight_online.png"
        edge_path = r"C:\Users\ferha\Desktop\ko_upgrade/desktop_images/microsoft_edge.png"
    ...
    def check_which_app_is_front(self):
        ...
        """
        check_front_path = r"C:\Users\ferha\Desktop\ko_upgrade/desktop_images/check_front.png"
        edge_path = r"C:\Users\ferha\Desktop\ko_upgrade/desktop_images/microsoft_edge.png"
        ...
        if target_app == "knight":
            ...
            if current_front != "knight_front":
                ...
                if self.is_desktop_image_visible(knight_path):
                    ...
                    time.sleep(1)
                    self.click_desktop_template(check_front_path)
    ...
    def close_microsoft_edge(self):
        ...
        if self.is_desktop_image_visible(edge_path):
            ...
            if result:
                ...
                interception.move_to(screen_x, screen_y)
                time.sleep(0.2)
                interception.click(x=screen_x, y=screen_y, button='right')
                time.sleep(0.5)
                ...
                interception.move_to(close_x, close_y)
                time.sleep(0.2)
                interception.click(x=close_x, y=close_y, button='left')
                time.sleep(1)
    ...
    def get_mouse_position(self):
        ...
        """
        pos = interception.get_cursor_position()
    ...
    def knight_online_login(self, username="BIYAX01", password="Tmmozmn16&"):
        ...
        self.click_capture_coords(1029, 439, clicks=2)
        time.sleep(3)
        
        # Start butonuna tıkla
        self.click_(984, 730, clicks=1)
    ...
    def start_upgrade_bot_first_time(self):
        ...
        # Terminal/Komut satırını aç # burası değişecek...
        self.click_(115, 1060)
        time.sleep(0.5)
        ...
        self.click_(175, 507, button="right")
        time.sleep(1)
        
        # Sol tıklama (terminal aç)
        self.click_(271, 526, button="left")
        time.sleep(5)
        
        # Conda environment'ı aktive et
        pyperclip.copy("conda activate ko_env")
        self.hotkey_('ctrl', 'v')
        time.sleep(0.5)
        self.press_("enter")
        time.sleep(2)
        ...
        # Proje klasörüne git
        pyperclip.copy("cd C:/Users/ferha/Desktop/ko_upgrade")
        self.hotkey_('ctrl', 'v')
        self.press_("enter")
        time.sleep(1)
