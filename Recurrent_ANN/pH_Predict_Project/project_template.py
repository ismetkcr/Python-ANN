...
random_df = read_excel_file_and_plot("train_data_pH.xlsx", show=True)
...
# windows_arx_square, labels_arx_square = make_multivariate_windows(data=square_normalized_df, window_size=WINDOW_SIZE)
# print("SQUARE Windows shape", windows_arx_square.shape)
# print("SQUARE labels shape:", labels_arx_square.shape)


# windows_arx_prbs4, labels_arx_prbs4 = make_multivariate_windows(data=prbs4_normalized_df, window_size=WINDOW_SIZE)
# print("prbs4 Windows shape", windows_arx_prbs4.shape)
# print("prbs4 labels shape:", labels_arx_prbs4.shape)


# windows_arx_prbs7, labels_arx_prbs7 = make_multivariate_windows(data=prbs7_normalized_df, window_size=WINDOW_SIZE)
# print("prbs7 Windows shape", windows_arx_prbs7.shape)
# print("prbs7 labels shape:", labels_arx_prbs7.shape)


# windows_arx_random, labels_arx_random = make_multivariate_windows(data=random_normalized_df, window_size=WINDOW_SIZE)
# print("random Windows shape", windows_arx_random.shape)
# print("random labels shape:", labels_arx_random.shape)

# all_windows_arx = np.concatenate([windows_arx_square, windows_arx_prbs4, windows_arx_prbs7, windows_arx_random])
# all_labels_arx = np.concatenate([labels_arx_square, labels_arx_prbs4, labels_arx_prbs7, labels_arx_random])

# # all_windows = np.concatenate([windows_prbs7, windows_random])
# # all_labels = np.concatenate([labels_prbs7, labels_random])
# print(len(all_windows_arx), len(all_labels_arx))
...
# train_windows_arx, test_windows_arx, train_labels , test_labels = make_train_test_splits(windows_arx, all_labels_arx, test_split=0.13)
...
#     test_u=random_normalized_df['base_flow'].values[-len(test_labels):],
...
# train_windows_ann, test_windows_ann, train_labels , test_labels = make_train_test_splits(windows_ann, all_labels_ann, test_split=0.13)
...
# train_windows_cnn, test_windows_cnn, train_labels , test_labels = make_train_test_splits(all_windows_cnn, all_labels_cnn, test_split=0.13)
...
# train_windows_rnn, test_windows_rnn, train_labels , test_labels = make_train_test_splits(all_windows_rnn, all_labels_rnn, test_split=0.13)
...
# print("Evaluation Metrics:", rnn_results)
