# -*- coding: utf-8 -*-
"""
Created on Thu Sep 26 11:08:25 2024
...
class Agent():
  def __init__(self, gamma = 0.99):
    ...
    self.action_space = [0, 1] #stick and hit

    self.state_space = []
    self.returns = {}
    self.states_visited = {} # first visit or not
    self.memory = [] # states encouned anm reward received
    self.gamma = gamma
  ...
  def update_V(self):
    ...
    for state in self.state_space:
      self.states_visited[state] = 0 #reset zero.. for each episode we keep it
