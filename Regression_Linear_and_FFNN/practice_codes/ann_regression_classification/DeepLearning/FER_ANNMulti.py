# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 13:14:56 2024
...
class ANNMulti(object):
  def __init__(self, M):
    self.M = M

  def fit(self, X, Y, learning_rate=10e-7, reg=1e-1, epochs=1000, show_fig=False):
    X, Y = shuffle(X, Y)
    ...
    for i in range(epochs):
      ...
      dZ = pY_T.dot(self.W2.T) * (1 - Z*Z) # tanh # tanh activation
